...
DY_process_weights_ntLO = DY_process_base_weights
...
DY_process_weights_ntLO.append((
...
DY_ntLO_process_selection = Selection(name = "DrellYan_ntLO",
                                      weights = DY_process_weights_ntLO)
